...
<script type="text/javascript" src="{{asset('vendor/jarhen-menu/scripts.js')}}"></script>
<script type="text/javascript" src="{{asset('vendor/jarhen-menu/scripts2.js')}}"></script>
<script type="text/javascript" src="{{asset('vendor/jarhen-menu/menu.js')}}"></script>