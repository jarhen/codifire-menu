...
class SubFormMakeCommand extends GeneratorCommand
{
     ...
     * @var string
     */
    protected $name = 'module:make-subform';
    ...
    public function getDestinationFilePath()
    {
        ...
        return $path . $viewPath->getPath() .'/'.strtolower($this->option('submodule')). '/_'.strtolower($this->option('submodule')). '_form.blade.php';
    }
    ...
    protected function getOptions()
    {
        return [
			...
			['submodule', null, InputOption::VALUE_OPTIONAL, ' get module.', null],
        ];
    }
