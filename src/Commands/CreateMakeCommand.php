...
class CreateMakeCommand extends GeneratorCommand
{
    ...
    public function getDestinationFilePath()
    {
        ...
        return $path . $viewPath->getPath() .'/'.strtolower($module->getStudlyName()). '/'.strtolower($module->getStudlyName()). '_create.blade.php';
    }
    ...
    protected function getTemplateContents()
    {
        ...
        return (new Stub($this->getStubName(), [
			...
			'SINGULARNAME'		=> ucfirst(str_singular($module->getLowerName())),
